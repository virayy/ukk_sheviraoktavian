...
<body>
    ...
    <div class="form-group">
        ...
        <input type="text" value="<?= $vira->nama_website ?>" class="form-control" name="namaWeb" id="namaWeb" placeholder="Nama Web">
    </div>

    <div class="form-group">
        <label for="iconTab">Tab Icon</label>
        <?php if ($vira->icon_logo): ?>
            <img src="<?= base_url('img/' . $vira->icon_logo) ?>" alt="Current Tab Icon" width="50" height="50">
        <?php endif; ?>
    ...
    <div class="form-group">
        ...
        <?php if ($vira->logo_dash): ?>
            <img src="<?= base_url('img/' . $vira->logo_dash) ?>" alt="Current Dashboard Icon" width="50" height="50">
        <?php endif; ?>
    ...
    <div class="form-group">
        ...
        <?php if ($vira->logo_login): ?>
            <img src="<?= base_url('img/' . $vira->logo_login) ?>" alt="Current Login Icon" width="50" height="50">
        <?php endif; ?>
